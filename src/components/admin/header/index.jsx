...
export function Header() {
  ...
  return (
    <header className="fixed top-0 z-30 right-0 left-0 md:left-64 h-16 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-gray-200 dark:border-slate-800  transition-all flex items-center">
      <div className="flex items-center justify-between w-full px-6">
        ...
        <div className="flex items-center gap-1 md:gap-3">
          ...
          <Button variant="ghost" size="icon" className="relative hover:bg-gray-100 dark:hover:bg-slate-800 rounded-full">
          ...
          <div className="hidden md:flex items-center gap-3 pl-2">
            ...
            <Avatar className="w-9 h-9 border border-gray-200 dark:border-slate-800 shadow-sm">
              ...
              <AvatarFallback className="bg-gray-100 dark:bg-slate-800">AD</AvatarFallback>
            </Avatar>
